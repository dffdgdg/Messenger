    ...
    ILogger<MessagesController> logger) : BaseController<MessagesController>(logger)
{
    ...
    public async Task<ActionResult<ApiResponse<MessageDto>>> CreateMessage(
        [FromBody] CreateMessageRequest request) => await ExecuteAsync(()
            => messageService.CreateMessageAsync(GetCurrentUserId(), request),
            "Сообщение успешно отправлено");

    [HttpPut("{id}")]
    public async Task<ActionResult<ApiResponse<MessageDto>>> UpdateMessage(
        int id, [FromBody] UpdateMessageDto updateDto) => await ExecuteAsync(async () =>
        {
            if (id != updateDto.Id)
    ...
    public async Task<IActionResult> DeleteMessage(int id)
        => await ExecuteAsync(() => messageService.DeleteMessageAsync(id, GetCurrentUserId()),
    ...
    public async Task<ActionResult<ApiResponse<PagedMessagesDto>>> GetChatMessages(
        ...
        [FromQuery] int pageSize = 15) => await ExecuteAsync(()
            => messageService.GetChatMessagesAsync(chatId, GetCurrentUserId(), page, pageSize),
    ...
    public async Task<ActionResult<ApiResponse<PagedMessagesDto>>> GetMessagesAround(
        ...
        [FromQuery] int count = 50) => await ExecuteAsync(()
    ...
    public async Task<ActionResult<ApiResponse<PagedMessagesDto>>> GetMessagesBefore(
        int chatId, int messageId,
        [FromQuery] int count = 30) => await ExecuteAsync(()
    ...
    public async Task<ActionResult<ApiResponse<SearchMessagesResponseDto>>> SearchMessages(
        ...
        [FromQuery] bool? hasFiles = null,
        [FromQuery] bool? hasVoice = null,
        [FromQuery] bool? hasPoll = null,
        [FromQuery] bool? onlyText = null,
        [FromQuery] DateTime? dateFrom = null,
        [FromQuery] DateTime? dateTo = null,
        [FromQuery] bool oldestFirst = false) => await ExecuteAsync(()
            => messageService.SearchMessagesAsync(
                chatId, GetCurrentUserId(), query, page, pageSize,
    ...
    public async Task<ActionResult<ApiResponse<GlobalSearchResponseDto>>> GlobalSearch(
        ...
        [FromQuery] int pageSize = 20,
        [FromQuery] int? senderId = null,
        [FromQuery] int? filterChatId = null,
        [FromQuery] bool? hasFiles = null,
        [FromQuery] bool? hasVoice = null,
        [FromQuery] bool? hasPoll = null,
        [FromQuery] bool? onlyText = null,
        ...
        [FromQuery] bool oldestFirst = false)
    {
        ...
        return await ExecuteAsync(() => messageService.GlobalSearchAsync(
            userId, query, page, pageSize,
            senderId, filterChatId,
            hasFiles, hasVoice, hasPoll, onlyText,
            dateFrom, dateTo, oldestFirst));
    }
}