...
public partial class MessengerDbContext(DbContextOptions<MessengerDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // Регистрация PostgreSQL enum-типов
        modelBuilder
            .HasPostgresEnum<ChatRole>(
                name: "chat_role",
                nameTranslator: (Npgsql.INpgsqlNameTranslator?)EnumTypeMappings.ChatRoleNameTranslator)
            .HasPostgresEnum<ChatType>(
                name: "chat_type",
                nameTranslator: (Npgsql.INpgsqlNameTranslator?)EnumTypeMappings.ChatTypeNameTranslator)
            .HasPostgresEnum<Theme>(
                name: "theme",
                nameTranslator: (Npgsql.INpgsqlNameTranslator?)EnumTypeMappings.ThemeNameTranslator)
            .HasPostgresEnum<SystemEventType>(
                name: "system_event_type",
                nameTranslator: (Npgsql.INpgsqlNameTranslator?)EnumTypeMappings.SystemEventTypeNameTranslator)
            .HasPostgresEnum<UserStatusType>(
                name: "user_status_type",
                nameTranslator: (Npgsql.INpgsqlNameTranslator?)EnumTypeMappings.UserStatusTypeNameTranslator);
        ...
        modelBuilder.Entity<Chat>(entity =>
        {
            ...
            entity.Property(e => e.ShowHistoryForNewMembers)
        ...
        modelBuilder.Entity<Message>(entity =>
        {
            ...
            // TPH discriminator
            entity.HasDiscriminator<bool>("message_type")
                .HasValue<UserMessage>(false)
                .HasValue<SystemMessage>(true);
            ...
            entity.HasIndex(e => new { e.ChatId, e.PinnedAt }, "idx_messages_chatid_pinnedat")
        ...
        modelBuilder.Entity<UserMessage>(entity =>
        {
            ...
            entity.HasOne(d => d.ForwardedFromMessage)
                .WithMany(p => p.InverseForwardedFromMessage)
            ...
            entity.HasMany(d => d.MessageFiles)
                .WithOne(p => p.Message)
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.Property(e => e.StatusExpiresAt)
                .HasColumnType("timestamp without time zone")
            ...
            entity.OwnsOne(u => u.Password, pw =>
                pw.Property(p => p.Hash).HasColumnName("password_hash"));
        });
