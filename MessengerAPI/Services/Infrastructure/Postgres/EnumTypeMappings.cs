...
public static class EnumTypeMappings
{
    ...
    public static EnumNameTranslator TranscriptionStatusNameTranslator { get; } = new(new Dictionary<string, string>(StringComparer.Ordinal)
    {
        [nameof(TranscriptionStatus.Pending)] = "pending",
        [nameof(TranscriptionStatus.Processing)] = "processing",
        [nameof(TranscriptionStatus.Done)] = "done",
        [nameof(TranscriptionStatus.Failed)] = "failed"
    });
