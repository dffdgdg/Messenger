...
public partial class ChatsView : UserControl
{
    ...
    protected override void OnAttachedToVisualTree(VisualTreeAttachmentEventArgs e)
    {
        ...
        _layoutModeSub = layoutProvider.LayoutModeChanged.Subscribe(new AnonymousObserver<LayoutMode>(m => LayoutMode = m));

        _windowBoundsSub = layoutProvider.WindowBoundsChanged.Subscribe(new AnonymousObserver<Rect>(_ =>
            {
