// Только Desktop — файл остаётся в папке Desktop/Services/Features/Call/
// НО теперь реализует интерфейс и НЕ имеет #if !ANDROID обёртки на уровне класса
// Вместо этого регистрация в DI контролирует какой класс используется
