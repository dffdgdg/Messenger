...
using Core.Shared.Converters.Boolean;
using Core.Shared.Converters.DateTime;
using Core.Shared.Converters.Domain;
using Core.Shared.Converters.Generic;

namespace Core.Shared.Converters;
...
public sealed class ConverterLocator
{
    ...
    private void RegisterAll()
    {
        ...
        Add<LayoutModeToSideNavVisibleConverter>("LayoutModeToSideNavVisible");
        Add<LayoutModeToBottomNavVisibleConverter>("LayoutModeToBottomNavVisible");
        Add<LayoutModeToNavColumnWidthConverter>("LayoutModeToNavColumnWidth");
        Add<LayoutModeToChatListWidthConverter>("LayoutModeToChatListWidth");
        Add<LayoutModeToChatListMinWidthConverter>("LayoutModeToChatListMinWidth");
        Add<LayoutModeToSplitterVisibleConverter>("LayoutModeToSplitterVisible");
        Add<LayoutModeToInfoPanelAlwaysVisibleConverter>("LayoutModeToInfoPanelAlwaysVisible");
        Add<LayoutModeIsUltraCompactConverter>("LayoutModeIsUltraCompact");
