...
public class UserRepositoryTests : IntegrationTestBase
{
    ...
    {
        await TestDataSeeder.SeedUserAsync(Context, "john_doe", "pass123");
    ...
    {
        await TestDataSeeder.SeedUserAsync(Context, "trim_test", "pass123");
    ...
    {
        var seeded = await TestDataSeeder.SeedUserAsync(Context, "testuser", "securePass");
    ...
    public async Task FindByIdWithPassword_ReturnsNull_WhenNotExists()
        => (await _repo.FindByIdWithPasswordAsync(999)).Should().BeNull();

    [Fact]
    public async Task UsernameExists_True()
    {
        await TestDataSeeder.SeedUserAsync(Context, "existing", "pass");
    ...
    {
        var user = await TestDataSeeder.SeedUserAsync(Context, "duplicate", "pass");
    ...
    {
        var user1 = await TestDataSeeder.SeedUserAsync(Context, "same_username", "pass");
        var user2 = await TestDataSeeder.SeedUserAsync(Context, "another", "pass");
    ...
    {
        await TestDataSeeder.SeedUserAsync(Context, "alice", "pass");
        await TestDataSeeder.SeedUserAsync(Context, "bob", "pass");
    ...
    {
        var seeded = await TestDataSeeder.SeedUserAsync(Context, "charlie", "pass");
    ...
    {
        var u1 = await TestDataSeeder.SeedUserAsync(Context, "user1", "pass");
        var u2 = await TestDataSeeder.SeedUserAsync(Context, "user2", "pass");
        await TestDataSeeder.SeedUserAsync(Context, "user3", "pass");
    ...
    {
        var seeded = await TestDataSeeder.SeedUserAsync(Context, "dave", "pass");
    ...
    {
        var seeded = await TestDataSeeder.SeedUserAsync(Context, "eve", "pass");
