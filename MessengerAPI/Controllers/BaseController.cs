...
namespace MessengerAPI.Controllers
{
    ...
    public abstract class BaseController<T>(ILogger<T> logger) : ControllerBase where T : BaseController<T>
    {
        ...
        protected ActionResult SuccessWithData<TData>(TData data, string? message = null) => Ok(new ApiResponse<TData>
        {
            Success = true,
            Data = data,
            Message = message,
        ...
        protected ActionResult<ApiResponse<TData>> Success<TData>(TData data, string? message = null) => Ok(new ApiResponse<TData>
        {
            Success = true,
            Data = data,
            Message = message,
        ...
        protected ActionResult<ApiResponse<object>> Success(string? message = null) => Ok(new ApiResponse<object>
        {
            Success = true,
            Message = message,
            Timestamp = DateTime.Now
        ...
        protected ActionResult<ApiResponse<TData>> Created<TData>(TData data, string message = "Ресурс успешно создан") => StatusCode(StatusCodes.Status201Created, new ApiResponse<TData>
        {
            Success = true,
            Data = data,
            Message = message,
        ...
        protected ActionResult<ApiResponse<TData>> BadRequest<TData>(string error, string? details = null) => BadRequest(new ApiResponse<TData>
        {
            Success = false,
            Error = error,
            Details = details,
        ...
        protected ActionResult BadRequestMessage(string error, string? details = null) => BadRequest(new ApiResponse<object>
        {
            Success = false,
            Error = error,
            Details = details,
        ...
        protected ActionResult<ApiResponse<TData>> NotFound<TData>(string error = "Ресурс не найден") => NotFound(new ApiResponse<TData>
        {
            Success = false,
            Error = error,
            Timestamp = DateTime.Now
        ...
        protected ActionResult<ApiResponse<TData>> Unauthorized<TData>(string error = "Неавторизованный доступ") => Unauthorized(new ApiResponse<TData>
        {
            Success = false,
            Error = error,
            Timestamp = DateTime.Now
        ...
        protected ActionResult<ApiResponse<TData>> Forbidden<TData>(string error = "Доступ запрещён") => StatusCode(StatusCodes.Status403Forbidden, new ApiResponse<TData>
        {
            Success = false,
            Error = error,
            Timestamp = DateTime.Now
        ...
        protected ActionResult Forbidden(string error = "Доступ запрещён") => StatusCode(StatusCodes.Status403Forbidden, new ApiResponse<object>
        {
            Success = false,
            Error = error,
            Timestamp = DateTime.Now
