...
public partial class MainWindowViewModel : BaseViewModel
{
    ...
    public ReadOnlyObservableCollection<DesktopNotificationViewModel> ActiveNotifications
        ...
        ICallHubConnection callHub)
    {
        ...
        _activeCallStore = activeCallStore
            ?? throw new ArgumentNullException(nameof(activeCallStore));
    ...
    public async Task Logout() => await SafeExecuteAsync(async () =>
    {
        ...
        if (_globalHub is GlobalHubConnection gh)
            gh.ResetForNewSession();
