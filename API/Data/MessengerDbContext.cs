...
public partial class MessengerDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.HasPostgresEnum<ChatRole>(name: "chat_role", nameTranslator: (Npgsql.INpgsqlNameTranslator?)EnumTypeMappings.ChatRoleNameTranslator)
            ...
            .HasPostgresEnum<UserStatusType>(name: "user_status_type", nameTranslator: (Npgsql.INpgsqlNameTranslator?)EnumTypeMappings.UserStatusTypeNameTranslator);
        ...
        modelBuilder.Entity<ChatMember>(entity =>
        {
            ...
            entity.HasOne(d => d.Chat).WithMany(p => p.ChatMembers).HasForeignKey(d => d.ChatId)
                .OnDelete(DeleteBehavior.Cascade).HasConstraintName("ChatMembers_ChatId_fkey");
            entity.HasOne(d => d.LastReadMessage).WithMany(p => p.ChatMembers).HasForeignKey(d => d.LastReadMessageId)
                .OnDelete(DeleteBehavior.SetNull).HasConstraintName("ChatMembers_LastReadMessageId_fkey");
        ...
        modelBuilder.Entity<Department>(entity =>
        {
            ...
            entity.HasOne(d => d.Chat).WithOne(p => p.Department).HasForeignKey<Department>(d => d.ChatId)
                .OnDelete(DeleteBehavior.SetNull).HasConstraintName("Departments_ChatId_fkey");
            entity.HasOne(d => d.Head).WithMany(p => p.Departments).HasForeignKey(d => d.HeadId)
                .OnDelete(DeleteBehavior.SetNull).HasConstraintName("Departments_Head_fkey");
            entity.HasOne(d => d.ParentDepartment).WithMany(p => p.InverseParentDepartment).HasForeignKey(d => d.ParentDepartmentId)
                .OnDelete(DeleteBehavior.SetNull).HasConstraintName("Departments_Parent_fkey");
        });
        ...
        modelBuilder.Entity<Message>(entity =>
        {
            ...
            entity.HasDiscriminator<bool>("message_type").HasValue<UserMessage>(false).HasValue<SystemMessage>(true);

            entity.Property<bool>("message_type").HasColumnName("message_type");

            entity.HasIndex(e => new { e.ChatId, e.CreatedAt }, "idx_messages_chatid_createdat");
            entity.HasIndex(e => new { e.ChatId, e.PinnedAt }, "idx_messages_chatid_pinnedat").HasFilter("pinned_at IS NOT NULL");
            ...
            entity.HasOne(d => d.Chat).WithMany(p => p.Messages).HasForeignKey(d => d.ChatId).OnDelete(DeleteBehavior.Cascade).HasConstraintName("Messages_ChatId_fkey");
        ...
        modelBuilder.Entity<UserMessage>(entity =>
        {
            ...
            entity.HasOne(d => d.Sender).WithMany(p => p.SentMessages).HasForeignKey(d => d.SenderId)
                .OnDelete(DeleteBehavior.SetNull).HasConstraintName("Messages_SenderId_fkey");

            entity.HasOne(d => d.ReplyToMessage).WithMany(p => p.InverseReplyToMessage).HasForeignKey(d => d.ReplyToMessageId)
                .OnDelete(DeleteBehavior.SetNull).HasConstraintName("Messages_ReplyToMessageId_fkey");
            entity.HasOne(d => d.ForwardedFromMessage).WithMany(p => p.InverseForwardedFromMessage).HasForeignKey(d => d.ForwardedFromMessageId)
                .OnDelete(DeleteBehavior.SetNull).HasConstraintName("Messages_ForwardedFromMessageId_fkey");

            entity.HasOne(d => d.Poll).WithOne(p => p.Message).HasForeignKey<Poll>(p => p.MessageId)
                .OnDelete(DeleteBehavior.Cascade).HasConstraintName("Polls_MessageId_fkey");

            entity.HasMany(d => d.MessageFiles).WithOne(p => p.Message).HasForeignKey(p => p.MessageId)
                .OnDelete(DeleteBehavior.Cascade).HasConstraintName("MessageFiles_MessageId_fkey");
        });
        ...
        modelBuilder.Entity<SystemMessage>(entity =>
        {
            ...
            entity.Property(e => e.InitiatorId).HasColumnName("sender_id");
            ...
            entity.HasOne(d => d.Initiator).WithMany().HasForeignKey(d => d.InitiatorId)
                .OnDelete(DeleteBehavior.SetNull).HasConstraintName("Messages_SenderId_fkey");
        ...
        modelBuilder.Entity<PollOption>(entity =>
        {
            ...
            entity.HasOne(d => d.Poll).WithMany(p => p.PollOptions).HasForeignKey(d => d.PollId)
                .OnDelete(DeleteBehavior.Cascade).HasConstraintName("PollOptions_PollId_fkey");
        });
        ...
        modelBuilder.Entity<PollVote>(entity =>
        {
            ...
            entity.HasOne(d => d.Option).WithMany(p => p.PollVotes).HasForeignKey(d => d.OptionId)
                .OnDelete(DeleteBehavior.Cascade).HasConstraintName("PollVotes_OptionId_fkey");
            entity.HasOne(d => d.Poll).WithMany(p => p.PollVotes).HasForeignKey(d => d.PollId)
                .OnDelete(DeleteBehavior.Cascade).HasConstraintName("PollVotes_PollId_fkey");
            entity.HasOne(d => d.User).WithMany(p => p.PollVotes).HasForeignKey(d => d.UserId)
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.Property(e => e.StatusType).HasColumnName("status_type").HasDefaultValue(UserStatusType.Online);
            ...
            entity.HasOne(d => d.Department).WithMany(p => p.Users).HasForeignKey(d => d.DepartmentId)
                .OnDelete(DeleteBehavior.SetNull).HasConstraintName("Users_DepartmentId_fkey");
            entity.OwnsOne(u => u.Password, pw => pw.Property(p => p.Hash).HasColumnName("password_hash"));
        });
        ...
        modelBuilder.Entity<RefreshToken>(entity =>
        {
            ...
            entity.HasOne(d => d.User).WithMany(p => p.RefreshTokens).HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.Cascade).HasConstraintName("RefreshTokens_UserId_fkey");
            entity.HasOne(d => d.ReplacedByToken).WithMany().HasForeignKey(d => d.ReplacedByTokenId)
                .OnDelete(DeleteBehavior.SetNull).HasConstraintName("RefreshTokens_ReplacedBy_fkey");
        });
    }
}